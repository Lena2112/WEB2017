...
$__System.registerDynamic("a", [], false, function ($__require, $__exports, $__module) {
    ...
    (function ($__global) {
        $__global["getAllFiles"] = getAllFiles;
        var get = $__global["get"],
            del = $__global["del"];
        ...
        get.onclick = function () {
            ...
            request.onreadystatechange = function () {
                ...
                if (request.status === 200) {
                    if (request.getResponseHeader("content-type") === "image/png" || request.getResponseHeader("content-type") === "image/jpg" || request.getResponseHeader("content-type") === "image/jpeg") {
                        var img = document.createElement("img");
                        img.src = document.getElementById("input").value;
                        document.getElementById("file").innerHTML = "";
                        document.getElementById("file").appendChild(img);
                    } else if (request.getResponseHeader("content-type") === "text/plain; charset=utf-8" || request.getResponseHeader("content-type") === "text/html; charset=utf-8" || request.getResponseHeader("content-type") === "text/css; charset=utf-8" || request.getResponseHeader("content-type") === "text/javascript; charset=utf-8") {
                        var p = document.createElement("p");
                        p.innerHTML = request.responseText;
                        document.getElementById("file").innerHTML = "";
                        document.getElementById("file").appendChild(p);
                    } else {
                        var name_1 = fileName.substr(fileName.lastIndexOf("/") + 1);
                        var element = document.createElement("a");
                        element.href = "data:application/octet-stream," + encodeURI(ext);
                        element.target = "_blank";
                        element.download = name_1;
                        element.click();
                    }
                } else {
